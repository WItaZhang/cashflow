...
V15_BASELINE_44 = [
    ...
    "recent_7d_to_30d_txn_ratio",
    "recent_30d_to_90d_txn_ratio",
    "all_cat_3_amount",
    "all_cat_12_amount",
    "all_cat_26_amount",
    "all_cat_26_count",
...
FEATURE_SETS = {
    "cashflow_44": V15_BASELINE_44,
    "frequency_6": V15_4_FFT_6,
    "behavior_6": V15_4_RISK_6,
    "balance_4": V15_4_BALANCE_4,
    "cashflow_56": V15_BASELINE_44 + V15_4_FFT_6 + V15_4_RISK_6,
    "cashflow_60": V15_BASELINE_44 + V15_4_FFT_6 + V15_4_RISK_6 + V15_4_BALANCE_4,
    # Historical names remain valid so saved experiment configs reproduce.
